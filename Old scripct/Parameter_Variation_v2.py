...
#                ['6378Lf,10m,100kRad_set-4',19.54,16.039,0,'100 kRad',False,True,False,0],
                [3,'6378Lf,10m,100kRad_set-1+3+5',19.54,16.039,0,'100 kRad set 1+2+3',True,True,False,True,0], 
...
LambdaVec = [0.065]
#Lambda = [0.067]
#AlphaVec = [-0.215,-0.245,-0.275,-0.305]
###=========================================================================================== 
...
if setMaxValue:
    ...
    Function = [#['Log function', Logfunc,2,[1,1],'dBm'],
                ...
                ['Weibull function - Alpha = {}'.format(Alpha),Weibull ,2,[0.09,-0.23],[-300,-16]],  #(0.09,-0.23)   6.5 = 0.166,1
    ...
    for j in range(0,len(plotData)):
        ...
        if getFit[j]:
            for k in range(0,len(ParVec)):
                ...
                legendVec.append('{0}-fit, {2} = {1}'.format(k,ParVec[k],vecPar))                 
...
#            pArray[k] = p
            ...
            fit[k] = func(fitTime,Lambda,Alpha)  

#        # futur fit
#        if showFutur:
#            futurTime = np.linspace(max(time)+0.1,futurMuliplier*max(time),200000)
#            futurFit = func(futurTime,Alpha,Lambda)
